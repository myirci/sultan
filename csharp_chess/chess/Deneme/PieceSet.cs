...
namespace Deneme
{
    ...
    public abstract class PieceSet
    {
        ...
        public Square KingSideCastledRookPos { get; protected set; }
        public Square QueenSideCastledRookPos { get; protected set; }
        public Square KingSideRookPos { get; protected set; }
        public Square QueenSideRookPos { get; protected set; }
        ...
        public int[] NegatedDiagStep { get; protected set; }
        public Square[] KingSideCastleKingPath { get; protected set; }
        public Square[] QueenSideCastleKingPath { get; protected set; }
    ...
    public class WhitePieces : PieceSet
    {
        public WhitePieces(Board brd) : base()
        {
            ...
            KingSideRookPos = Square.h1;
            QueenSideRookPos = Square.a1;
            KingSideCastledRookPos = Square.f1;
            QueenSideCastledRookPos = Square.d1;

            PawnStartRank = 1;
            PawnFinalRank = 6;
            FileStep = 16;
            DiagStep = new int[2] { 15, 17 };
            NegatedDiagStep = new int[2] { -15, -17 };
            KingSideCastleKingPath = new Square[2] { Square.f1, Square.g1 };
            QueenSideCastleKingPath = new Square[2] { Square.d1, Square.c1 };
    ...
    public class BlackPieces : PieceSet
    {
        public BlackPieces(Board brd) : base()
        {
            ...
            KingSideRookPos = Square.h8;
            QueenSideRookPos = Square.a8;
            KingSideCastledRookPos = Square.f8;
            QueenSideCastledRookPos = Square.d8;
            ...
            DiagStep = new int[2] { -15, -17 };
            NegatedDiagStep = new int[2] { 15, 17 };
            KingSideCastleKingPath = new Square[2] { Square.f8, Square.g8 };
            QueenSideCastleKingPath = new Square[2] { Square.d8, Square.c8 };
